...
/*
  ...
  get_cold_nodes_by_pages: function(page, pagesize, cb) {
    ...
    ColdNodeInfo.find({}).sort({rewards: -1}).skip(skipcount).limit(pagesize).exec(function(err, peers) {
      if (err) {
        return cb([]);
      } else {
        return cb(peers);
  ...
  get_stake_nodes_by_pages: function(page, pagesize, cb) {
    var skipcount = (page - 1) * pagesize;
    StakeNodeInfo.find({}).sort({stakingcoin: -1}).skip(skipcount).limit(pagesize).exec(function(err, peers) {
      if (err) {
        return cb([]);
      } else {
        return cb(peers);
  ...
  get_cold_nodes: function(cb) {
    ColdNodeInfo.find({}).sort({rewards: -1}).exec(function(err, peers) {
      if (err) {
        return cb([]);
      } else {
        return cb(peers);
  ...
  get_stake_nodes: function(cb) {
    StakeNodeInfo.find({}).sort({stakingcoin: -1}).exec(function(err, peers) {
      if (err) {
        return cb([]);
      } else {
        return cb(peers);
  ...
  get_sorted_cold_nodes: function(cb) {
    ColdNodeInfo.find({}).sort({rewards: -1}).limit(20).exec(function(err, peers) {
      if (err) {
        return cb([]);
      } else {
        return cb(peers);
  ...
  get_sorted_coldstaking_nodes: function(cb) {
    ColdStakeNode.find({}).sort({rewards: -1}).limit(1000).exec(function(err, peers) {
      if (err) {
        return cb([]);
      } else {
        return cb(peers);
