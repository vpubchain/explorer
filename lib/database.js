                  ...
                  lib.calculate_total(vout, function(total){
                    ...
                    if(nvin[0].addresses == "coinbase") {
                      lib.syncLoop(vout.length, function(voutLoop){
                        var o = voutLoop.iteration();
                        update_address_rewards(vout[o].addresses, vout[o].amount, function(){
                          console.log("地址:" + vout[o].addresses)
                          //分别给各个基金赋值
                          switch (vout[o].addresses) {
                            case settings.ecological_funds_address:
                              ecologicalfundreward = vout[o].amount;
                              break;
                            case settings.performance_funds_address:
                              performancefundreward = vout[o].amount;
                              break;
                            case settings.development_team_fund_address:
                              developmentfundreward = vout[o].amount;
                              break;       
                            default:
                              break;
                          }
